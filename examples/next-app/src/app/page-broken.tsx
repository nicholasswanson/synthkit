...
// We'll use React state instead of global variables to avoid memory leaks
...
// Generate payments based on scenario
...
export default function Home() {
  ...
  useEffect(() => {
    const initializeMSW = async () => {
      try {
        ...
        // Initial scenario is already in the ref
  ...
  useEffect(() => {
    const saved = localStorage.getItem('synthkit-category');
    if (saved) {
      try {
